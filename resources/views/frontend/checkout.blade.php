			...
			<div class="wrap-address-billing">
				...
				<form action="#" method="get" name="frm-billing">
					<p class="row-in-form">
						...
						<input id="fname" type="text" name="fname" value="{{ auth()->user()->name }}" placeholder="Your name">
					</p>
					<p class="row-in-form">
					...
					<p class="row-in-form">
						...
						<input id="add" type="text" name="add" value="{{ auth()->user()->address }}" placeholder="Street at apartment number">
					</p>
					<p class="row-in-form">
